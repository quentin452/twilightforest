...
public class BlockTFNagastone extends Block {
    ...
    public int getLightValue(IBlockAccess world, int x, int y, int z) {
		...
		if(te.blockMetadata == -1) {
        	...
        	switch(world.getBlockMetadata(x, y, z)) {
	        	default:
	        	case 0:
	        		worldClient.setBlockMetadataWithNotify(x, y, z, 0, 2);
	        		worldClient.setTileEntity(x, y, z, new TileEntityTFNagastone(Direction.SIDE, Facing.NORTH));
	        		break;
	        	case 1:
	        		worldClient.setBlockMetadataWithNotify(x, y, z, 0, 2);
	        		worldClient.setTileEntity(x, y, z, new TileEntityTFNagastone(Direction.SIDE, Facing.SOUTH));
	        		break;
	        	case 2:
	        		worldClient.setBlockMetadataWithNotify(x, y, z, 0, 2);
	        		worldClient.setTileEntity(x, y, z, new TileEntityTFNagastone(Direction.SIDE, Facing.WEST));
	        		break;
	        	case 3:
	        		worldClient.setBlockMetadataWithNotify(x, y, z, 0, 2);
	        		worldClient.setTileEntity(x, y, z, new TileEntityTFNagastone(Direction.SIDE, Facing.EAST));
	        		break;
	        	case 4:
	        	case 8:
	        		worldClient.setBlockMetadataWithNotify(x, y, z, 1, 2);
	        		worldClient.setTileEntity(x, y, z, new TileEntityTFNagastone(Direction.SIDE, Facing.NORTH));
	        		break;
	        	case 5:
	        	case 9:
	        	...
	        	case 14: {
	        		...
	        		Facing facing;
	        		TileEntityTFNagastone neighbour = (TileEntityTFNagastone)world.getTileEntity(x, y - 1, z);
	        		if(neighbour == null) 
	    			...
	    			worldClient.setTileEntity(x, y, z, new TileEntityTFNagastone(direction, facing));
	        		break;
	        	}
	        	case 15: {
	        		worldClient.setBlockMetadataWithNotify(x, y, z, 1, 2);
	        		...
	        		Facing facing;
	        		TileEntityTFNagastone neighbourZminus = (TileEntityTFNagastone)world.getTileEntity(x, y, z - 1);
	        		TileEntityTFNagastone neighbourZplus = (TileEntityTFNagastone)world.getTileEntity(x, y, z + 1);
	        		if(neighbourZminus != null || neighbourZplus != null)
	        			facing = Facing.WEST;
	        		else
	        			facing = Facing.NORTH;
	        		worldClient.setTileEntity(x, y, z, new TileEntityTFNagastone(direction, facing));
    ...
    public void onBlockPlacedBy(World par1World, int x, int y, int z, EntityLivingBase par5EntityLiving, ItemStack par6ItemStack)
    {
    	...
    	do {
    		...
    		posY += moveY;
    		posZ += moveZ;
    	} while(posX >= (borderX - 1) && posX <= borderX && posY >= (borderY - 1) && posY <= borderY && posZ >= (borderZ - 1) && posZ <= borderZ);
    	int side = 0;
    	if(posY > borderY)
    		side = 0;
    	else
        	...
        	if(posX < (borderX - 1))
            	...
            	if(posX > borderX)
                	...
                	if(posZ > borderZ)
	                	...
	                	if(posZ < (borderZ - 1))
	                		side = 5;
    	TileEntityTFNagastone te = new TileEntityTFNagastone(side, x, z, (float)par5EntityLiving.posX, (float)par5EntityLiving.posZ, par5EntityLiving.isSneaking());
...
//    }
    ...
    public boolean CanConnectTo(World world, int x, int y, int z, int direction) {
		...
		if(world.getBlockMetadata(x, y, z) == 1)
			if(isNagaStoneInDirection(world, x, y, z, direction)) {
		    	...
		    	if(neighbourBlock.getBlockMetadata() == 0) {
		    		...
		    		switch(direction) {
			    		case 0:
			    			...
			    			break;
			    		case 1:
		    				if(neighbourBlock.direction != Direction.UP)
		    					return false;
		    				else {
		    					if(currentBlock.direction == Direction.SIDE)
		    						switch(currentBlock.facing) {
		    		...
		    		case 0:
		    		case 1:
		    			if((currentBlock.direction == Direction.SIDE && neighbourBlock.direction == Direction.SIDE) || (currentBlock.direction != Direction.SIDE && neighbourBlock.direction != Direction.SIDE && neighbourBlock.facing != currentBlock.facing)){
		    				return false;
		    			}
		    			else
		    				switch(currentBlock.facing) {
		    		...
		    		case 3:
		    			if(currentBlock.direction == Direction.SIDE){
		    				...
		    				case EAST:
		    				case WEST:
		    					if(neighbourBlock.direction == Direction.SIDE)
		    						return true;
		    					else
		    						return (neighbourBlock.facing == Facing.EAST || neighbourBlock.facing == Facing.WEST);
		    				case NORTH:
...
//    	}
    ...
    public void registerBlockIcons(IIconRegister par1IconRegister)
    {
        ...
        BlockTFNagastone.TOP_ANGLE_DOWN = par1IconRegister.registerIcon(TwilightForestMod.ID + ":nagastone_top_angle_down");
        BlockTFNagastone.TOP_TRIPLE_UP = par1IconRegister.registerIcon(TwilightForestMod.ID + ":nagastone_top_triple_up");
        BlockTFNagastone.TOP_TRIPLE_DOWN = par1IconRegister.registerIcon(TwilightForestMod.ID + ":nagastone_top_triple_down");
        ...
        BlockTFNagastone.LEFT_DOWN_CLEAR = par1IconRegister.registerIcon(TwilightForestMod.ID + ":nagastone_left_down_clear");
        BlockTFNagastone.LEFT_DOWN_ORNATED = par1IconRegister.registerIcon(TwilightForestMod.ID + ":nagastone_left_down_ornated");
        BlockTFNagastone.LEFT_UP_CLEAR = par1IconRegister.registerIcon(TwilightForestMod.ID + ":nagastone_left_up_clear");
        BlockTFNagastone.LEFT_UP_ORNATED = par1IconRegister.registerIcon(TwilightForestMod.ID + ":nagastone_left_up_ornated");
        BlockTFNagastone.RIGHT_DOWN_CLEAR = par1IconRegister.registerIcon(TwilightForestMod.ID + ":nagastone_right_down_clear");
        BlockTFNagastone.RIGHT_DOWN_ORNATED = par1IconRegister.registerIcon(TwilightForestMod.ID + ":nagastone_right_down_ornated");
        BlockTFNagastone.RIGHT_UP_CLEAR = par1IconRegister.registerIcon(TwilightForestMod.ID + ":nagastone_right_up_clear");
        BlockTFNagastone.RIGHT_UP_ORNATED = par1IconRegister.registerIcon(TwilightForestMod.ID + ":nagastone_right_up_ornated");
        ...
        BlockTFNagastone.TRIPLE_RIGHT_UP_LB = par1IconRegister.registerIcon(TwilightForestMod.ID + ":nagastone_triple_right_up_lb");
        BlockTFNagastone.TRIPLE_RIGHT_DOWN_LB = par1IconRegister.registerIcon(TwilightForestMod.ID + ":nagastone_triple_right_down_lb");
        BlockTFNagastone.TRIPLE_RIGHT_UP_RB = par1IconRegister.registerIcon(TwilightForestMod.ID + ":nagastone_triple_right_up_rb");
        BlockTFNagastone.TRIPLE_RIGHT_DOWN_RB = par1IconRegister.registerIcon(TwilightForestMod.ID + ":nagastone_triple_right_down_rb");
        BlockTFNagastone.TRIPLE_LEFT_UP_LB = par1IconRegister.registerIcon(TwilightForestMod.ID + ":nagastone_triple_left_up_lb");
        BlockTFNagastone.TRIPLE_LEFT_DOWN_LB = par1IconRegister.registerIcon(TwilightForestMod.ID + ":nagastone_triple_left_down_lb");
        BlockTFNagastone.TRIPLE_LEFT_UP_RB = par1IconRegister.registerIcon(TwilightForestMod.ID + ":nagastone_triple_left_up_rb");
        BlockTFNagastone.TRIPLE_LEFT_DOWN_RB = par1IconRegister.registerIcon(TwilightForestMod.ID + ":nagastone_triple_left_down_rb");
        ...
        BlockTFNagastone.BOTTOM_ANGLE_UP = par1IconRegister.registerIcon(TwilightForestMod.ID + ":nagastone_bottom_angle_up");
        BlockTFNagastone.BOTTOM_ANGLE_DOWN = par1IconRegister.registerIcon(TwilightForestMod.ID + ":nagastone_bottom_angle_down");
        BlockTFNagastone.BOTTOM_TRIPLE_UP = par1IconRegister.registerIcon(TwilightForestMod.ID + ":nagastone_bottom_triple_up");
        BlockTFNagastone.BOTTOM_TRIPLE_DOWN = par1IconRegister.registerIcon(TwilightForestMod.ID + ":nagastone_bottom_triple_down");
