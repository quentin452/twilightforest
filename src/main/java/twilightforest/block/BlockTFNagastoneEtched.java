...
//	}
	...
	public IIcon getIcon(int side, int meta) {
		IIcon[][] iconList = {
				{ TEX_TILES, TEX_BARE, TEX_DOWN, TEX_UP, TEX_LEFT, TEX_RIGHT },
				{ TEX_TILES_MOSSY, TEX_BARE_MOSSY, TEX_DOWN_MOSSY, TEX_UP_MOSSY, TEX_LEFT_MOSSY, TEX_RIGHT_MOSSY },
				{ TEX_TILES_WEATHERED, TEX_BARE_WEATHERED, TEX_DOWN_WEATHERED, TEX_UP_WEATHERED, TEX_LEFT_WEATHERED, TEX_RIGHT_WEATHERED }
				};
		meta = meta % 3;
		switch(direction) {
			default:
	...
	public void registerBlockIcons(IIconRegister par1IconRegister)
	{
		...
		BlockTFNagastoneEtched.TEX_TILES_MOSSY = par1IconRegister.registerIcon(TwilightForestMod.ID + ":stone_tiles_mossy");
		BlockTFNagastoneEtched.TEX_TILES_WEATHERED = par1IconRegister.registerIcon(TwilightForestMod.ID + ":stone_tiles_weathered");
		BlockTFNagastoneEtched.TEX_BARE = par1IconRegister.registerIcon(TwilightForestMod.ID + ":nagastone_bare");
		BlockTFNagastoneEtched.TEX_BARE_MOSSY = par1IconRegister.registerIcon(TwilightForestMod.ID + ":nagastone_bare_mossy");
		BlockTFNagastoneEtched.TEX_BARE_WEATHERED = par1IconRegister.registerIcon(TwilightForestMod.ID + ":nagastone_bare_weathered");
		BlockTFNagastoneEtched.TEX_DOWN = par1IconRegister.registerIcon(TwilightForestMod.ID + ":etched_nagastone_down");
		BlockTFNagastoneEtched.TEX_DOWN_MOSSY = par1IconRegister.registerIcon(TwilightForestMod.ID + ":etched_nagastone_down_mossy");
		BlockTFNagastoneEtched.TEX_DOWN_WEATHERED = par1IconRegister.registerIcon(TwilightForestMod.ID + ":etched_nagastone_down_weathered");
		BlockTFNagastoneEtched.TEX_UP = par1IconRegister.registerIcon(TwilightForestMod.ID + ":etched_nagastone_up");
		BlockTFNagastoneEtched.TEX_UP_MOSSY = par1IconRegister.registerIcon(TwilightForestMod.ID + ":etched_nagastone_up_mossy");
		BlockTFNagastoneEtched.TEX_UP_WEATHERED = par1IconRegister.registerIcon(TwilightForestMod.ID + ":etched_nagastone_up_weathered");
		BlockTFNagastoneEtched.TEX_LEFT = par1IconRegister.registerIcon(TwilightForestMod.ID + ":etched_nagastone_left");
		BlockTFNagastoneEtched.TEX_LEFT_MOSSY = par1IconRegister.registerIcon(TwilightForestMod.ID + ":etched_nagastone_left_mossy");
		BlockTFNagastoneEtched.TEX_LEFT_WEATHERED = par1IconRegister.registerIcon(TwilightForestMod.ID + ":etched_nagastone_left_weathered");
		BlockTFNagastoneEtched.TEX_RIGHT = par1IconRegister.registerIcon(TwilightForestMod.ID + ":etched_nagastone_right");
		BlockTFNagastoneEtched.TEX_RIGHT_MOSSY = par1IconRegister.registerIcon(TwilightForestMod.ID + ":etched_nagastone_right_mossy");
		BlockTFNagastoneEtched.TEX_RIGHT_WEATHERED = par1IconRegister.registerIcon(TwilightForestMod.ID + ":etched_nagastone_right_weathered");
	}
