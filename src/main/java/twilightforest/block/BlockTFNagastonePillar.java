...
public class BlockTFNagastonePillar extends BlockRotatedPillar {
	...
	public enum BlockType { NORMAL, MOSSY, WEATHERED };
	...
	public void registerBlockIcons(IIconRegister par1IconRegister)
	{
		...
		this.PILLAR_END_WEATHERED = par1IconRegister.registerIcon(TwilightForestMod.ID + ":nagastone_pillar_end_weathered");
		...
		this.PILLAR_SIDE_WEATHERED = par1IconRegister.registerIcon(TwilightForestMod.ID + ":nagastone_pillar_side_weathered");
		this.PILLAR_SIDE_ALT = par1IconRegister.registerIcon(TwilightForestMod.ID + ":nagastone_pillar_side_alt");
		this.PILLAR_SIDE_ALT_MOSSY = par1IconRegister.registerIcon(TwilightForestMod.ID + ":nagastone_pillar_side_alt_mossy");
		this.PILLAR_SIDE_ALT_WEATHERED = par1IconRegister.registerIcon(TwilightForestMod.ID + ":nagastone_pillar_side_alt_weathered");
	}
