...
public class BlockTFSpiralBricks extends Block {
	...
	public enum RenderMode {UEX, UEY, UEXY, UWX, UWY, UWXY, USZ, USY, USZY, UNZ, UNY, UNZY, DEX, DEY, DEXY, DWX, DWY, DWXY, DSZ, DSY, DSZY, DNZ, DNY, DNZY, DEXInv, DEYInv};
    ...
    public void registerBlockIcons(IIconRegister par1IconRegister)
    {
    	...
    	this.spiralCornerLeftDownMirrored = par1IconRegister.registerIcon(TwilightForestMod.ID + ":stone_spiral_left_down_mirrored");
    	this.spiralCornerLeftUpMirrored = par1IconRegister.registerIcon(TwilightForestMod.ID + ":stone_spiral_left_up_mirrored");
    	this.spiralCornerRightDownMirrored = par1IconRegister.registerIcon(TwilightForestMod.ID + ":stone_spiral_right_down_mirrored");
    	this.spiralCornerRightUpMirrored = par1IconRegister.registerIcon(TwilightForestMod.ID + ":stone_spiral_right_up_mirrored");
