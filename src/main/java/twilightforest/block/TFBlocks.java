...
public class TFBlocks {
    ...
    public static Block chestTwilight;
    public static Block chestCanopy;
    public static Block chestMangrove;
    public static Block chestDarkwood;
    public static Block chestTime;
    public static Block chestTrans;
    public static Block chestMine;
    public static Block chestSort;
    public static Block trappedChestTwilight;
    public static Block trappedChestCanopy;
    public static Block trappedChestMangrove;
    public static Block trappedChestDarkwood;
    public static Block trappedChestTime;
    public static Block trappedChestTrans;
    public static Block trappedChestMine;
    public static Block trappedChestSort;
