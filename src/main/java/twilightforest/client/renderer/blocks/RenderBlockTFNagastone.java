...
public class RenderBlockTFNagastone implements ISimpleBlockRenderingHandler {
    ...
    public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId,
        ...
        if (te == null || te.isOutdated) {
            ...
            /*
             * worldClient.setBlockToAir(x, y, z); worldClient.setBlock(x, y, z, TFBlocks.nagastone, 14, 1);
        ...
        // Tails
            ...
            switch (dir) {
                ...
                case SIDE:
                    ...
                    if (te.neighbourUp) upperBlock = (TileEntityTFNagastone) world.getTileEntity(x, y + 1, z);
                    TileEntityTFNagastone lowerBlock = null;
                    if (te.neighbourDown) lowerBlock = (TileEntityTFNagastone) world.getTileEntity(x, y - 1, z);
                    switch (face) {
                        default:
                        case EAST:
                            // Lower & upper faces
