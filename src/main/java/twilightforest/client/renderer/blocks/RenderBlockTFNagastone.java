...
public class RenderBlockTFNagastone implements ISimpleBlockRenderingHandler {
	...
	public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId, RenderBlocks renderer) {
		...
		if(te.isOutdated) {
        	...
        	case 14: {
    			...
    			if(neighbour == null) {
    				Boolean airXplus = worldClient.getBlock(x + 1, y, z) == Blocks.air;
    				Boolean airXminus = worldClient.getBlock(x - 1, y, z) == Blocks.air;
    				Boolean airZplus = worldClient.getBlock(x, y, z + 1) == Blocks.air;
    				Boolean airZminus = worldClient.getBlock(x, y, z - 1) == Blocks.air;
    		...
    		/*worldClient.setBlockToAir(x, y, z);
    		worldClient.setBlock(x, y, z, TFBlocks.nagastone, 14, 1);
    		worldClient.removeTileEntity(x, y, z);*/
    		//worldClient.setTileEntity(x, y, z, new TileEntityTFNagastone());
		}
		RenderRotatedBlock(renderer, (BlockTFNagastone)block, x, y, z);
		return true;
	...
	public boolean RenderYNeg(RenderBlocks renderer, Block block, int x, int y, int z, float red, float green, float blue, IIcon iicon) {
	...
	public boolean RenderYPos(RenderBlocks renderer, Block block, int x, int y, int z, float red, float green, float blue, IIcon iicon) {
        renderer.enableAO = true;
        boolean flag = false;
        float f3 = 0.0F;
        float f4 = 0.0F;
	...
	public boolean RenderXNeg(RenderBlocks renderer, Block block, int x, int y, int z, float red, float green, float blue, IIcon iicon) {
        renderer.enableAO = true;
        boolean flag = false;
        float f3 = 0.0F;
        float f4 = 0.0F;
	...
	public boolean RenderXPos(RenderBlocks renderer, Block block, int x, int y, int z, float red, float green, float blue, IIcon iicon) {
        renderer.enableAO = true;
        boolean flag = false;
        float f3 = 0.0F;
        float f4 = 0.0F;
	...
	public boolean RenderZNeg(RenderBlocks renderer, Block block, int x, int y, int z, float red, float green, float blue, IIcon iicon) {
        renderer.enableAO = true;
        boolean flag = false;
        float f3 = 0.0F;
        float f4 = 0.0F;
	...
	public boolean RenderZPos(RenderBlocks renderer, Block block, int x, int y, int z, float red, float green, float blue, IIcon iicon) {
        renderer.enableAO = true;
        boolean flag = false;
        float f3 = 0.0F;
        float f4 = 0.0F;
	...
	private void RenderRotatedBlock(RenderBlocks renderer, BlockTFNagastone block, int x, int y, int z) {
		World world = Minecraft.getMinecraft().theWorld;
		int meta = world.getBlockMetadata(x, y, z);
		block.Check4Neighbours(world, x, y, z);
		TileEntityTFNagastone te = (TileEntityTFNagastone)world.getTileEntity(x, y, z);
        TileEntityTFNagastone.Direction dir = te.direction;
        TileEntityTFNagastone.Facing face = te.facing;
        ...
        //Tails
        	...
        	case SIDE:
    			iconYNeg = block.BOTTOM_LONG;
    			iconYPos = block.TOP_LONG;
    			TileEntityTFNagastone upperBlock = null;
    			if(te.neighbourUp)
    				upperBlock = (TileEntityTFNagastone)world.getTileEntity(x, y + 1, z);
    			TileEntityTFNagastone lowerBlock = null;
    			if(te.neighbourDown)
    				lowerBlock = (TileEntityTFNagastone)world.getTileEntity(x, y - 1, z);
	    		switch(face) {
	    		default:
	    		case EAST:
	    			//Lower & upper faces
	    				...
	    				default:
	    					if(!(te.neighbourEast && te.neighbourWest)) {
		    					if(te.neighbourUp && !te.neighbourDown) {
		    						if(upperBlock.facing == Facing.EAST) {
			    						if(te.neighbourEast) {
				                    		renderer.uvRotateBottom = 0;
				        					iconYNeg = block.BOTTOM_TIP;
			    						}
		    					...
		    					if(!te.neighbourUp && te.neighbourDown) {
		    						if(lowerBlock.facing == Facing.EAST) {
			    						if(te.neighbourEast) {
				                    		renderer.uvRotateTop = 3;
			    						}
			    						if(te.neighbourWest)
    				...
    				switch(te.GetConnectionType(2)) {
	        			...
	        			case CROSS:
	        			case UD:
	        				if(upperBlock.facing == Facing.EAST && lowerBlock.facing == Facing.EAST) {
		    					if(!te.neighbourEast && te.neighbourWest) {
		                    		renderer.uvRotateSouth = 2;
		    						iconXPos = block.BOTTOM_LONG;
		    					}
	        				...
	        				else if(upperBlock.facing == Facing.WEST && lowerBlock.facing == Facing.WEST) {
		    					if(!te.neighbourEast && te.neighbourWest) {
		                    		renderer.uvRotateSouth = 1;
		    						iconXPos = block.TOP_LONG;
		    					}
	    		...
	    		case NORTH:
	    			...
	    			switch(te.GetConnectionType(0)) {
	    				default:
	    					if(!(te.neighbourSouth && te.neighbourNorth)) {
		    					if(te.neighbourUp && !te.neighbourDown) {
		    						if(upperBlock.facing == Facing.SOUTH) {
			    						if(te.neighbourSouth) {
				                    		renderer.uvRotateBottom = 2;
				        					iconYNeg = block.BOTTOM_TIP;
			    						}
		    					...
		    					if(!te.neighbourUp && te.neighbourDown) {
		    						if(lowerBlock.facing == Facing.SOUTH) {
			    						if(te.neighbourSouth) {
				                    		renderer.uvRotateTop = 2;
			    						}
			    						if(te.neighbourNorth)
	    			...
	    			switch(te.GetConnectionType(2)) {
	    				default:
	    					...
	    					break;
	    				case triS:
	        				if(upperBlock.facing == Facing.SOUTH && lowerBlock.facing == Facing.SOUTH) {
		    					if(!te.neighbourEast) {
		                    		renderer.uvRotateSouth = 1;
		    						iconXPos = block.TRIPLE_LEFT_UP_RB;
		    					}
	        				...
	        				else if(upperBlock.facing == Facing.NORTH && lowerBlock.facing == Facing.NORTH) {
		    					if(!te.neighbourEast) {
		                    		renderer.uvRotateSouth = 2;
		    						iconXPos = block.TRIPLE_RIGHT_DOWN_LB;
		    					}
