...
public class RenderBlockTFNagastoneStairs implements ISimpleBlockRenderingHandler  {
    ...
    public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId, RenderBlocks renderer) {
    	...
    	if(block.getBlockBoundsMinY() == 0) {
        	if(currentBlock.facingRight)
        		currentBlock.parentBlock.direction = Direction.StairsRightBottom;
        	else
        		currentBlock.parentBlock.direction = Direction.StairsLeftBottom;
    	}
    	else {
        	if(currentBlock.facingRight)
        		currentBlock.parentBlock.direction = Direction.StairsRightTop;
        	else
        		currentBlock.parentBlock.direction = Direction.StairsLeftTop;
    	}
