...
public class RenderBlockTFSpiralBricks implements ISimpleBlockRenderingHandler {
	...
	public static boolean renderSpiralBricks(RenderBlocks renderblocks, IBlockAccess world, int x, int y, int z, Block block) {
		float pixel = 0.0625F;
        ...
        case 0:
            ...
            renderblocks.renderStandardBlock(block, x, y, z);
            renderblocks.setRenderBounds(1.0F - 6 * pixel, 3 * pixel, 0.5F, 1.0F - 3 * pixel, 1.0F, 1.0F - pixel * 3 / 4);
            renderblocks.renderStandardBlock(block, x, y, z);
    		
    		// x3
            renderblocks.setRenderBounds(1.0F - 9 * pixel, 9 * pixel, pixel * 5 / 4, 1.0F - 6 * pixel, 1.0F, 0.5F);
            renderblocks.renderStandardBlock(block, x, y, z);
            renderblocks.setRenderBounds(1.0F - 9 * pixel, 6 * pixel, 0.5F, 1.0F - 6 * pixel, 1.0F, 1.0F - pixel * 7 / 4);
            renderblocks.renderStandardBlock(block, x, y, z);
    		
    		// x4
            renderblocks.setRenderBounds(1.0F - 12 * pixel, 12 * pixel, pixel * 9 / 4, 1.0F - 9 * pixel, 1.0F, 0.5F);
            renderblocks.renderStandardBlock(block, x, y, z);
            renderblocks.setRenderBounds(1.0F - 12 * pixel, 9 * pixel, 0.5F, 1.0F - 9 * pixel, 1.0F, 1.0F - pixel * 11 / 4);
            renderblocks.renderStandardBlock(block, x, y, z);
    		
    		// x5
            renderblocks.setRenderBounds(1.0F - 15 * pixel, 15 * pixel, pixel * 13 / 4, 1.0F - 12 * pixel, 1.0F, 0.5F);
            renderblocks.renderStandardBlock(block, x, y, z);
            renderblocks.setRenderBounds(1.0F - 15 * pixel, 12 * pixel, 0.5F, 1.0F - 12 * pixel, 1.0F, 1.0F - pixel * 15 / 4);
            renderblocks.renderStandardBlock(block, x, y, z);
            ...
            renderblocks.renderStandardBlock(block, x, y, z);
            renderblocks.setRenderBounds(0.0F, 9 * pixel, 0.5F, 1.0F - 12 * pixel, 12 * pixel, 1.0F - pixel * 5 / 2);
            renderblocks.renderStandardBlock(block, x, y, z);
    		
    		// y5
            renderblocks.setRenderBounds(0.0F, 12 * pixel, pixel * 7 / 2, 1.0F - 12 * pixel, 15 * pixel, 0.5F);
            renderblocks.renderStandardBlock(block, x, y, z);
            renderblocks.setRenderBounds(0.0F, 12 * pixel, 0.5F, 1.0F - 15 * pixel, 15 * pixel, 1.0F - pixel * 7 / 2);
            renderblocks.renderStandardBlock(block, x, y, z);
        ...
        case 2:
            ...
            renderblocks.renderStandardBlock(block, x, y, z);
            renderblocks.setRenderBounds(0.5F, 6 * pixel, 1.0F - 6 * pixel, 1.0F - pixel / 4, 1.0F, 1.0F - 3 * pixel);
            renderblocks.renderStandardBlock(block, x, y, z);
    		
    		// z3
            renderblocks.setRenderBounds(pixel * 7 / 4, 6 * pixel, 1.0F - 9 * pixel, 0.5F, 1.0F, 1.0F - 6 * pixel);
            renderblocks.renderStandardBlock(block, x, y, z);
            renderblocks.setRenderBounds(0.5F, 9 * pixel, 1.0F - 9 * pixel, 1.0F - pixel * 5 / 4, 1.0F, 1.0F - 6 * pixel);
            renderblocks.renderStandardBlock(block, x, y, z);
    		
    		// z4
            renderblocks.setRenderBounds(pixel * 11 / 4, 9 * pixel, 1.0F - 12 * pixel, 0.5F, 1.0F, 1.0F - 9 * pixel);
            renderblocks.renderStandardBlock(block, x, y, z);
            renderblocks.setRenderBounds(0.5F, 12 * pixel, 1.0F - 12 * pixel, 1.0F - pixel * 9 / 4, 1.0F, 1.0F - 9 * pixel);
            renderblocks.renderStandardBlock(block, x, y, z);
    		
    		// z5
            renderblocks.setRenderBounds(pixel * 15 / 4, 12 * pixel, 1.0F - 15 * pixel, 0.5F, 1.0F, 1.0F - 12 * pixel);
            renderblocks.renderStandardBlock(block, x, y, z);
            renderblocks.setRenderBounds(0.5F, 15 * pixel, 1.0F - 15 * pixel, 1.0F - pixel * 13 / 4, 1.0F, 1.0F - 12 * pixel);
            renderblocks.renderStandardBlock(block, x, y, z);
            ...
            renderblocks.renderStandardBlock(block, x, y, z);
            renderblocks.setRenderBounds(0.5F, 12 * pixel, 0.0F, 1.0F - pixel * 7 / 2, 15 * pixel, 1.0F - 12 * pixel);
            renderblocks.renderStandardBlock(block, x, y, z);
        ...
        case 4:
    		...
    		// x2
            renderblocks.setRenderBounds(1.0F - 6 * pixel, 0.0F, pixel * 1 / 4, 1.0F - 3 * pixel, 1.0F - 3 * pixel, 0.5F);
            renderblocks.renderStandardBlock(block, x, y, z);
            renderblocks.setRenderBounds(1.0F - 6 * pixel, 0.0F, 0.5F, 1.0F - 3 * pixel, 1.0F - 6 * pixel, 1.0F - pixel * 3 / 4);
            renderblocks.renderStandardBlock(block, x, y, z);
    		
    		// x3
            renderblocks.setRenderBounds(1.0F - 9 * pixel, 0.0F, pixel * 5 / 4, 1.0F - 6 * pixel, 1.0F - 3 * pixel, 0.5F);
            renderblocks.renderStandardBlock(block, x, y, z);
            renderblocks.setRenderBounds(1.0F - 9 * pixel, 0.0F, 0.5F, 1.0F - 6 * pixel, 1.0F - 9 * pixel, 1.0F - pixel * 7 / 4);
            renderblocks.renderStandardBlock(block, x, y, z);
    		
    		// x4
            renderblocks.setRenderBounds(1.0F - 12 * pixel, 0.0F, pixel * 9 / 4, 1.0F - 9 * pixel, 1.0F - 6 * pixel, 0.5F);
            renderblocks.renderStandardBlock(block, x, y, z);
            renderblocks.setRenderBounds(1.0F - 12 * pixel, 0.0F, 0.5F, 1.0F - 9 * pixel, 1.0F - 12 * pixel, 1.0F - pixel * 11 / 4);
            renderblocks.renderStandardBlock(block, x, y, z);
    		
    		// x5
            renderblocks.setRenderBounds(1.0F - 15 * pixel, 0.0F, pixel * 13 / 4, 1.0F - 12 * pixel, 1.0F - 9 * pixel, 0.5F);
            renderblocks.renderStandardBlock(block, x, y, z);
            renderblocks.setRenderBounds(1.0F - 15 * pixel, 0.0F, 0.5F, 1.0F - 12 * pixel, 1.0F - 15 * pixel, 1.0F - pixel * 15 / 4);
            renderblocks.renderStandardBlock(block, x, y, z);
        ...
        case 5:
            ...
            renderblocks.renderStandardBlock(block, x, y, z);
            renderblocks.setRenderBounds(12 * pixel, 0.0F, 0.5F, 15 * pixel, 1.0F - 9 * pixel, 1.0F - pixel * 13 / 4);
            renderblocks.renderStandardBlock(block, x, y, z);
            ...
            renderblocks.renderStandardBlock(block, x, y, z);
            renderblocks.setRenderBounds(12 * pixel, 1.0F - 9 * pixel, 0.5F, 1.0F, 1.0F - 6 * pixel, 1.0F - pixel * 2);
            renderblocks.renderStandardBlock(block, x, y, z);
    		
    		// y4
            renderblocks.setRenderBounds(9 * pixel, 1.0F - 12 * pixel, pixel * 3, 1.0F, 1.0F - 9 * pixel, 0.5F);
            renderblocks.renderStandardBlock(block, x, y, z);
            renderblocks.setRenderBounds(15 * pixel, 1.0F - 12 * pixel, 0.5F, 1.0F, 1.0F - 9 * pixel, 1.0F - pixel * 3);
            renderblocks.renderStandardBlock(block, x, y, z);
    		
    		// y5
            renderblocks.setRenderBounds(12 * pixel, 1.0F - 15 * pixel, pixel * 4, 1.0F, 1.0F - 12 * pixel, 0.5F);
            renderblocks.renderStandardBlock(block, x, y, z);
            renderblocks.setRenderBounds(15 * pixel, 1.0F - 15 * pixel, 0.5F, 1.0F, 1.0F - 12 * pixel, 1.0F - pixel * 4);
            renderblocks.renderStandardBlock(block, x, y, z);
        ...
        case 6:
    		...
    		// z2
            renderblocks.setRenderBounds(pixel * 3 / 4, 0.0F, 1.0F - 6 * pixel, 0.5F, 1.0F - 6 * pixel, 1.0F - 3 * pixel);
            renderblocks.renderStandardBlock(block, x, y, z);
            renderblocks.setRenderBounds(0.5F, 0.0F, 1.0F - 6 * pixel, 1.0F - pixel * 1 / 4, 1.0F - 3 * pixel, 1.0F - 3 * pixel);
            renderblocks.renderStandardBlock(block, x, y, z);
    		
    		// z3
            renderblocks.setRenderBounds(pixel * 7 / 4, 0.0F, 1.0F - 9 * pixel, 0.5F, 1.0F - 9 * pixel, 1.0F - 6 * pixel);
            renderblocks.renderStandardBlock(block, x, y, z);
            renderblocks.setRenderBounds(0.5F, 0.0F, 1.0F - 9 * pixel, 1.0F - pixel * 5 / 4, 1.0F - 3 * pixel, 1.0F - 6 * pixel);
            renderblocks.renderStandardBlock(block, x, y, z);
    		
    		// z4
            renderblocks.setRenderBounds(pixel * 11 / 4, 0.0F, 1.0F - 12 * pixel, 0.5F, 1.0F - 12 * pixel, 1.0F - 9 * pixel);
            renderblocks.renderStandardBlock(block, x, y, z);
            renderblocks.setRenderBounds(0.5F, 0.0F, 1.0F - 12 * pixel, 1.0F - pixel * 9 / 4, 1.0F - 6 * pixel, 1.0F - 9 * pixel);
            renderblocks.renderStandardBlock(block, x, y, z);
    		
    		// z5
            renderblocks.setRenderBounds(pixel * 15 / 4, 0.0F, 1.0F - 15 * pixel, 0.5F, 1.0F - 15 * pixel, 1.0F - 12 * pixel);
            renderblocks.renderStandardBlock(block, x, y, z);
            renderblocks.setRenderBounds(0.5F, 0.0F, 1.0F - 15 * pixel, 1.0F - pixel * 13 / 4, 1.0F - 9 * pixel, 1.0F - 12 * pixel);
            renderblocks.renderStandardBlock(block, x, y, z);
            ...
            renderblocks.renderStandardBlock(block, x, y, z);
            renderblocks.setRenderBounds(0.5F, 1.0F - 6 * pixel, 0.0F, 1.0F - pixel, 1.0F - 3 * pixel, 1.0F - 9 * pixel);
            renderblocks.renderStandardBlock(block, x, y, z);
    		
    		// y3
            renderblocks.setRenderBounds(pixel * 2, 1.0F - 9 * pixel, 0.0F, 0.5F, 1.0F - 6 * pixel, 1.0F - 6 * pixel);
            renderblocks.renderStandardBlock(block, x, y, z);
            renderblocks.setRenderBounds(0.5F, 1.0F - 9 * pixel, 0.0F, 1.0F - pixel *  2, 1.0F - 6 * pixel, 1.0F - 12 * pixel);
            renderblocks.renderStandardBlock(block, x, y, z);
    		
    		// y4
            renderblocks.setRenderBounds(pixel * 3, 1.0F - 12 * pixel, 0.0F, 0.5F, 1.0F - 9 * pixel, 1.0F - 9 * pixel);
            renderblocks.renderStandardBlock(block, x, y, z);
            renderblocks.setRenderBounds(0.5F, 1.0F - 12 * pixel, 0.0F, 1.0F - pixel * 3, 1.0F - 9 * pixel, 1.0F - 15 * pixel);
            renderblocks.renderStandardBlock(block, x, y, z);
    		
    		// y5
            renderblocks.setRenderBounds(pixel * 4, 1.0F - 15 * pixel, 0.0F, 0.5F, 1.0F - 12 * pixel, 1.0F - 12 * pixel);
            renderblocks.renderStandardBlock(block, x, y, z);
            renderblocks.setRenderBounds(0.5F, 1.0F - 15 * pixel, 0.0F, 1.0F - pixel * 4, 1.0F - 12 * pixel, 1.0F - 15 * pixel);
            renderblocks.renderStandardBlock(block, x, y, z);
        ...
        case 7:
            ...
            renderblocks.renderStandardBlock(block, x, y, z);
            renderblocks.setRenderBounds(0.5F, 0.0F, 9 * pixel, 1.0F - pixel * 11 / 4, 1.0F - 12 * pixel, 12 * pixel);
            renderblocks.renderStandardBlock(block, x, y, z);
    		
    		// z5
            renderblocks.setRenderBounds(pixel * 13 / 4, 0.0F, 12 * pixel, 0.5F, 1.0F - 9 * pixel, 15 * pixel);
            renderblocks.renderStandardBlock(block, x, y, z);
            renderblocks.setRenderBounds(0.5F, 0.0F, 12 * pixel, 1.0F - pixel * 15 / 4, 1.0F - 15 * pixel, 15 * pixel);
            renderblocks.renderStandardBlock(block, x, y, z);
            ...
            renderblocks.renderStandardBlock(block, x, y, z);
            renderblocks.setRenderBounds(0.5F, 1.0F - 9 * pixel, 6 * pixel, 1.0F - pixel * 2, 1.0F - 6 * pixel, 1.0F);
            renderblocks.renderStandardBlock(block, x, y, z);
    		
    		// y4
            renderblocks.setRenderBounds(pixel * 3, 1.0F - 12 * pixel, 15 * pixel, 0.5F, 1.0F - 9 * pixel, 1.0F);
            renderblocks.renderStandardBlock(block, x, y, z);
            renderblocks.setRenderBounds(0.5F, 1.0F - 12 * pixel, 9 * pixel, 1.0F - pixel * 3, 1.0F - 9 * pixel, 1.0F);
            renderblocks.renderStandardBlock(block, x, y, z);
    		
    		// y5
            renderblocks.setRenderBounds(pixel * 4, 1.0F - 15 * pixel, 15 * pixel, 0.5F, 1.0F - 12 * pixel, 1.0F);
            renderblocks.renderStandardBlock(block, x, y, z);
            renderblocks.setRenderBounds(0.5F, 1.0F - 15 * pixel, 12 * pixel, 1.0F - pixel * 4, 1.0F - 12 * pixel, 1.0F);
            renderblocks.renderStandardBlock(block, x, y, z);
