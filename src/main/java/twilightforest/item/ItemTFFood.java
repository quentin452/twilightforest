...
public class ItemTFFood extends ItemFood {
    ...
    @Override
    public boolean onItemUse(ItemStack itemStackIn, EntityPlayer player, World worldIn, int x, int y, int z, int side, float p_77648_8_, float p_77648_9_, float p_77648_10_)
    {
    	if(player.isSneaking() && itemStackIn.getItem() == TFItems.experiment115)
		{
	        ...
	        return super.onItemUse(itemStackIn, player, worldIn, x, y, z, side, p_77648_8_, p_77648_9_, p_77648_10_);
    }
