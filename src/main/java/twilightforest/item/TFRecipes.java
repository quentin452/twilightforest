...
public class TFRecipes {
	...
	public static void registerRecipes() {
		...
		GameRegistry.addRecipe(new ItemStack(TFBlocks.nagastoneStairsLeft, 8, 0), new Object[] {"#  ", "## ", "###", '#', new ItemStack(TFBlocks.nagastoneEtched, 1, 0)});
		GameRegistry.addRecipe(new ItemStack(TFBlocks.nagastoneStairsRight, 8, 0), new Object[] {"###", " ##", "  #", '#', new ItemStack(TFBlocks.nagastoneEtched, 1, 0)});
		GameRegistry.addRecipe(new ItemStack(TFBlocks.nagastoneStairsMossyLeft, 8, 0), new Object[] {"#  ", "## ", "###", '#', new ItemStack(TFBlocks.nagastoneEtched, 1, 1)});
		GameRegistry.addRecipe(new ItemStack(TFBlocks.nagastoneStairsMossyRight, 8, 0), new Object[] {"###", " ##", "  #", '#', new ItemStack(TFBlocks.nagastoneEtched, 1, 1)});
		GameRegistry.addRecipe(new ItemStack(TFBlocks.nagastoneStairsWeatheredLeft, 8, 0), new Object[] {"#  ", "## ", "###", '#', new ItemStack(TFBlocks.nagastoneEtched, 1, 2)});
		GameRegistry.addRecipe(new ItemStack(TFBlocks.nagastoneStairsWeatheredRight, 8, 0), new Object[] {"###", " ##", "  #", '#', new ItemStack(TFBlocks.nagastoneEtched, 1, 2)});
		GameRegistry.addShapelessRecipe(new ItemStack(TFBlocks.nagastoneEtched, 3, 0), new Object[] {TFBlocks.nagastoneStairsLeft, TFBlocks.nagastoneStairsLeft, TFBlocks.nagastoneStairsLeft, TFBlocks.nagastoneStairsLeft});
		GameRegistry.addShapelessRecipe(new ItemStack(TFBlocks.nagastoneEtched, 3, 0), new Object[] {TFBlocks.nagastoneStairsRight, TFBlocks.nagastoneStairsRight, TFBlocks.nagastoneStairsRight, TFBlocks.nagastoneStairsRight});
		GameRegistry.addShapelessRecipe(new ItemStack(TFBlocks.nagastoneEtched, 3, 1), new Object[] {TFBlocks.nagastoneStairsMossyLeft, TFBlocks.nagastoneStairsMossyLeft, TFBlocks.nagastoneStairsMossyLeft, TFBlocks.nagastoneStairsMossyLeft});
		GameRegistry.addShapelessRecipe(new ItemStack(TFBlocks.nagastoneEtched, 3, 1), new Object[] {TFBlocks.nagastoneStairsMossyRight, TFBlocks.nagastoneStairsMossyRight, TFBlocks.nagastoneStairsMossyRight, TFBlocks.nagastoneStairsMossyRight});
		GameRegistry.addShapelessRecipe(new ItemStack(TFBlocks.nagastoneEtched, 3, 2), new Object[] {TFBlocks.nagastoneStairsWeatheredLeft, TFBlocks.nagastoneStairsWeatheredLeft, TFBlocks.nagastoneStairsWeatheredLeft, TFBlocks.nagastoneStairsWeatheredLeft});
		GameRegistry.addShapelessRecipe(new ItemStack(TFBlocks.nagastoneEtched, 3, 2), new Object[] {TFBlocks.nagastoneStairsWeatheredRight, TFBlocks.nagastoneStairsWeatheredRight, TFBlocks.nagastoneStairsWeatheredRight, TFBlocks.nagastoneStairsWeatheredRight});
		
		GameRegistry.addRecipe(new ItemStack(TFBlocks.spiralStoneBricks, 8, 0), new Object[] {"#XX", "#XX", "###", '#', Blocks.stone, 'X', new ItemStack(Blocks.stone_slab, 1, 0)});
		GameRegistry.addRecipe(new ItemStack(TFBlocks.spiralStoneBricks, 8, 0), new Object[] {"#XX", "#XX", "###", '#', Blocks.stone, 'X', new ItemStack(Blocks.stone_slab, 1, 5)});
		GameRegistry.addRecipe(new ItemStack(TFBlocks.spiralStoneBricks, 8, 0), new Object[] {"#XX", "#XX", "###", '#', Blocks.stonebrick, 'X', new ItemStack(Blocks.stone_slab, 1, 0)});
		GameRegistry.addRecipe(new ItemStack(TFBlocks.spiralStoneBricks, 8, 0), new Object[] {"#XX", "#XX", "###", '#', Blocks.stonebrick, 'X', new ItemStack(Blocks.stone_slab, 1, 5)});
