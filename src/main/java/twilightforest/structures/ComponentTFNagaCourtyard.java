	...
	public boolean addComponentParts(World world, Random rand, StructureBoundingBox sbb) {
		...
		for (int fx = 0; fx <= DIAMETER; fx++) {
			...
			case 17 :
				...
				setTileEntityAtCurrentPosition(world, new TileEntityTFNagastone(Direction.UP, Facing.EAST), fx, 3, DIAMETER, sbb);
				placeBlockAtCurrentPosition(world, TFBlocks.nagastone,  1, fx, 3, 0, sbb);
				setTileEntityAtCurrentPosition(world, new TileEntityTFNagastone(Direction.UP, Facing.EAST), fx, 3, 0, sbb);
				placeBlockAtCurrentPosition(world, TFBlocks.nagastone, 1, fx, 2, DIAMETER, sbb);
				setTileEntityAtCurrentPosition(world, new TileEntityTFNagastone(Direction.UP, Facing.EAST), fx, 2, DIAMETER, sbb);
				placeBlockAtCurrentPosition(world, TFBlocks.nagastone, 1, fx, 2, 0, sbb);
				setTileEntityAtCurrentPosition(world, new TileEntityTFNagastone(Direction.UP, Facing.EAST), fx, 2, 0, sbb);
				placeBlockAtCurrentPosition(world, TFBlocks.nagastone, 1, fx, 1, DIAMETER, sbb);
				setTileEntityAtCurrentPosition(world, new TileEntityTFNagastone(Direction.UP, Facing.EAST), fx, 1, DIAMETER, sbb);
				placeBlockAtCurrentPosition(world, TFBlocks.nagastone, 1, fx, 1, 0, sbb);
				setTileEntityAtCurrentPosition(world, new TileEntityTFNagastone(Direction.UP, Facing.EAST), fx, 1, 0, sbb);
				break;
			case 3 :
				placeBlockAtCurrentPosition(world, TFBlocks.nagastone,  0, fx, 3, DIAMETER, sbb);
				setTileEntityAtCurrentPosition(world, new TileEntityTFNagastone(Direction.SIDE, Facing.EAST), fx, 3, DIAMETER, sbb);
				placeBlockAtCurrentPosition(world, TFBlocks.nagastone,  0, fx, 3, 0, sbb);
				setTileEntityAtCurrentPosition(world, new TileEntityTFNagastone(Direction.SIDE, Facing.EAST), fx, 3, 0, sbb);
				placeBlockAtCurrentPosition(world, TFBlocks.nagastone, 1, fx, 1, DIAMETER, sbb);
				setTileEntityAtCurrentPosition(world, new TileEntityTFNagastone(Direction.SIDE, Facing.WEST), fx, 1, DIAMETER, sbb);
				placeBlockAtCurrentPosition(world, TFBlocks.nagastone, 1, fx, 1, 0, sbb);
				setTileEntityAtCurrentPosition(world, new TileEntityTFNagastone(Direction.SIDE, Facing.WEST), fx, 1, 0, sbb);
				break;
			case 4 :
			case 8 :
				placeBlockAtCurrentPosition(world, TFBlocks.nagastone, 1, fx, 1, DIAMETER, sbb);
			...
			case 22 :
				placeBlockAtCurrentPosition(world, TFBlocks.nagastone,  1, fx, 3, DIAMETER, sbb);
				setTileEntityAtCurrentPosition(world, new TileEntityTFNagastone(Direction.UP, Facing.WEST), fx, 3, DIAMETER, sbb);
				placeBlockAtCurrentPosition(world, TFBlocks.nagastone,  1, fx, 3, 0, sbb);
				setTileEntityAtCurrentPosition(world, new TileEntityTFNagastone(Direction.UP, Facing.WEST), fx, 3, 0, sbb);
				placeBlockAtCurrentPosition(world, TFBlocks.nagastone, 1, fx, 2, DIAMETER, sbb);
				setTileEntityAtCurrentPosition(world, new TileEntityTFNagastone(Direction.UP, Facing.WEST), fx, 2, DIAMETER, sbb);
				placeBlockAtCurrentPosition(world, TFBlocks.nagastone, 1, fx, 2, 0, sbb);
				setTileEntityAtCurrentPosition(world, new TileEntityTFNagastone(Direction.UP, Facing.WEST), fx, 2, 0, sbb);
				placeBlockAtCurrentPosition(world, TFBlocks.nagastone, 1, fx, 1, DIAMETER, sbb);
				setTileEntityAtCurrentPosition(world, new TileEntityTFNagastone(Direction.UP, Facing.WEST), fx, 1, DIAMETER, sbb);
				placeBlockAtCurrentPosition(world, TFBlocks.nagastone, 1, fx, 1, 0, sbb);
				setTileEntityAtCurrentPosition(world, new TileEntityTFNagastone(Direction.UP, Facing.WEST), fx, 1, 0, sbb);
				break;
			case 14 :
			case 18 :
				placeBlockAtCurrentPosition(world, TFBlocks.nagastone, 1, fx, 3, DIAMETER, sbb);
				setTileEntityAtCurrentPosition(world, new TileEntityTFNagastone(Direction.SIDE, Facing.EAST), fx, 1, DIAMETER, sbb);
				placeBlockAtCurrentPosition(world, TFBlocks.nagastone, 1, fx, 3, 0, sbb);
				setTileEntityAtCurrentPosition(world, new TileEntityTFNagastone(Direction.SIDE, Facing.EAST), fx, 1, 0, sbb);
				break;
			case 16 :
			case 20 :
				placeBlockAtCurrentPosition(world, TFBlocks.nagastone, 1, fx, 1, DIAMETER, sbb);
			...
			case 21 :
				placeBlockAtCurrentPosition(world, TFBlocks.nagastone,  0, fx, 3, DIAMETER, sbb);
				setTileEntityAtCurrentPosition(world, new TileEntityTFNagastone(Direction.SIDE, Facing.WEST), fx, 3, DIAMETER, sbb);
				placeBlockAtCurrentPosition(world, TFBlocks.nagastone,  0, fx, 3, 0, sbb);
				setTileEntityAtCurrentPosition(world, new TileEntityTFNagastone(Direction.SIDE, Facing.WEST), fx, 3, 0, sbb);
				placeBlockAtCurrentPosition(world, TFBlocks.nagastone, 1, fx, 1, DIAMETER, sbb);
				setTileEntityAtCurrentPosition(world, new TileEntityTFNagastone(Direction.SIDE, Facing.EAST), fx, 1, DIAMETER, sbb);
				placeBlockAtCurrentPosition(world, TFBlocks.nagastone, 1, fx, 1, 0, sbb);
				setTileEntityAtCurrentPosition(world, new TileEntityTFNagastone(Direction.SIDE, Facing.EAST), fx, 1, 0, sbb);
...
//			}
		...
		for (int fz = 0; fz <= DIAMETER; fz++) {
			...
			case 17 :
				...
				setTileEntityAtCurrentPosition(world, new TileEntityTFNagastone(Direction.UP, Facing.SOUTH), DIAMETER, 3, fz, sbb);
				placeBlockAtCurrentPosition(world, TFBlocks.nagastone,  1, 0, 3, fz, sbb);
				setTileEntityAtCurrentPosition(world, new TileEntityTFNagastone(Direction.UP, Facing.SOUTH), 0, 3, fz, sbb);
				placeBlockAtCurrentPosition(world, TFBlocks.nagastone, 1, DIAMETER, 2, fz, sbb);
				setTileEntityAtCurrentPosition(world, new TileEntityTFNagastone(Direction.UP, Facing.SOUTH), DIAMETER, 2, fz, sbb);
				placeBlockAtCurrentPosition(world, TFBlocks.nagastone, 1, 0, 2, fz, sbb);
				setTileEntityAtCurrentPosition(world, new TileEntityTFNagastone(Direction.UP, Facing.SOUTH), 0, 2, fz, sbb);
				placeBlockAtCurrentPosition(world, TFBlocks.nagastone,  1, DIAMETER, 1, fz, sbb);
				setTileEntityAtCurrentPosition(world, new TileEntityTFNagastone(Direction.UP, Facing.SOUTH), DIAMETER, 1, fz, sbb);
				placeBlockAtCurrentPosition(world, TFBlocks.nagastone,  1, 0, 1, fz, sbb);
				setTileEntityAtCurrentPosition(world, new TileEntityTFNagastone(Direction.UP, Facing.SOUTH), 0, 1, fz, sbb);
				break;
			case 3 :
				placeBlockAtCurrentPosition(world, TFBlocks.nagastone,  0, DIAMETER, 3, fz, sbb);
				setTileEntityAtCurrentPosition(world, new TileEntityTFNagastone(Direction.SIDE, Facing.SOUTH), DIAMETER, 3, fz, sbb);
				placeBlockAtCurrentPosition(world, TFBlocks.nagastone,  0, 0, 3, fz, sbb);
				setTileEntityAtCurrentPosition(world, new TileEntityTFNagastone(Direction.SIDE, Facing.NORTH), 0, 3, fz, sbb);
				placeBlockAtCurrentPosition(world, TFBlocks.nagastone, 1, DIAMETER, 1, fz, sbb);
				setTileEntityAtCurrentPosition(world, new TileEntityTFNagastone(Direction.SIDE, Facing.SOUTH), DIAMETER, 1, fz, sbb);
				placeBlockAtCurrentPosition(world, TFBlocks.nagastone, 1, 0, 1, fz, sbb);
				setTileEntityAtCurrentPosition(world, new TileEntityTFNagastone(Direction.SIDE, Facing.NORTH), 0, 1, fz, sbb);
				break;
			case 4 :
			case 8 :
				placeBlockAtCurrentPosition(world, TFBlocks.nagastone, 1, DIAMETER, 1, fz, sbb);
				setTileEntityAtCurrentPosition(world, new TileEntityTFNagastone(Direction.SIDE, Facing.NORTH), DIAMETER, 1, fz, sbb);
				placeBlockAtCurrentPosition(world, TFBlocks.nagastone, 1, 0, 1, fz, sbb);
				setTileEntityAtCurrentPosition(world, new TileEntityTFNagastone(Direction.SIDE, Facing.NORTH), 0, 1, fz, sbb);
				break;
			case 6 :
			case 10 :
				placeBlockAtCurrentPosition(world, TFBlocks.nagastone, 1, DIAMETER, 3, fz, sbb);
				setTileEntityAtCurrentPosition(world, new TileEntityTFNagastone(Direction.SIDE, Facing.NORTH), DIAMETER, 3, fz, sbb);
				placeBlockAtCurrentPosition(world, TFBlocks.nagastone, 1, 0, 3, fz, sbb);
				setTileEntityAtCurrentPosition(world, new TileEntityTFNagastone(Direction.SIDE, Facing.NORTH), 0, 3, fz, sbb);
				break;
			case 7 :
			...
			case 22 :
				placeBlockAtCurrentPosition(world, TFBlocks.nagastone,  1, DIAMETER, 3, fz, sbb);
				setTileEntityAtCurrentPosition(world, new TileEntityTFNagastone(Direction.UP, Facing.NORTH), DIAMETER, 3, fz, sbb);
				placeBlockAtCurrentPosition(world, TFBlocks.nagastone,  1, 0, 3, fz, sbb);
				setTileEntityAtCurrentPosition(world, new TileEntityTFNagastone(Direction.UP, Facing.NORTH), 0, 3, fz, sbb);
				placeBlockAtCurrentPosition(world, TFBlocks.nagastone, 1, DIAMETER, 2, fz, sbb);
				setTileEntityAtCurrentPosition(world, new TileEntityTFNagastone(Direction.UP, Facing.NORTH), DIAMETER, 2, fz, sbb);
				placeBlockAtCurrentPosition(world, TFBlocks.nagastone, 1, 0, 2, fz, sbb);
				setTileEntityAtCurrentPosition(world, new TileEntityTFNagastone(Direction.UP, Facing.NORTH), 0, 2, fz, sbb);
				placeBlockAtCurrentPosition(world, TFBlocks.nagastone,  1, DIAMETER, 1, fz, sbb);
				setTileEntityAtCurrentPosition(world, new TileEntityTFNagastone(Direction.UP, Facing.NORTH), DIAMETER, 1, fz, sbb);
				placeBlockAtCurrentPosition(world, TFBlocks.nagastone,  1, 0, 1, fz, sbb);
				setTileEntityAtCurrentPosition(world, new TileEntityTFNagastone(Direction.UP, Facing.NORTH), 0, 1, fz, sbb);
				break;
			case 14 :
			case 18 :
				placeBlockAtCurrentPosition(world, TFBlocks.nagastone, 1, DIAMETER, 3, fz, sbb);
				...
				setTileEntityAtCurrentPosition(world, new TileEntityTFNagastone(Direction.SIDE, Facing.SOUTH), 0, 3, fz, sbb);
				break;
			case 16 :
			case 20 :
				placeBlockAtCurrentPosition(world, TFBlocks.nagastone, 1, DIAMETER, 1, fz, sbb);
				setTileEntityAtCurrentPosition(world, new TileEntityTFNagastone(Direction.SIDE, Facing.SOUTH), DIAMETER, 1, fz, sbb);
				placeBlockAtCurrentPosition(world, TFBlocks.nagastone, 1, 0, 1, fz, sbb);
				setTileEntityAtCurrentPosition(world, new TileEntityTFNagastone(Direction.SIDE, Facing.SOUTH), 0, 1, fz, sbb);
				break;
			case 21 :
				placeBlockAtCurrentPosition(world, TFBlocks.nagastone,  0, DIAMETER, 3, fz, sbb);
				setTileEntityAtCurrentPosition(world, new TileEntityTFNagastone(Direction.SIDE, Facing.NORTH), DIAMETER, 3, fz, sbb);
