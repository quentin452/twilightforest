...
public class ComponentTFNagaCourtyardHedgePillar extends ComponentTFNagaCourtyardHedge {
    ...
    public boolean addComponentParts(World world, Random random, StructureBoundingBox structureBoundingBox) {
    	...
    	this.fillWithBlocks(world, structureBoundingBox, 2, 0, 2, 2, 9, 2, TFBlocks.nagastoneEtched, TFBlocks.nagastoneEtched, false);
    	this.fillWithBlocks(world, structureBoundingBox, 1, 10, 1, 3, 10, 3, Blocks.stone_slab, Blocks.stone_slab, false);
    	this.placeBlockAtCurrentPosition(world, Blocks.stonebrick, 0, 2, 10, 2, structureBoundingBox);
    	this.fillWithMetadataBlocks(world, structureBoundingBox, 2, 0, 2, 2, 1, 2, andesite, andesiteMeta, andesite, andesiteMeta, false);
