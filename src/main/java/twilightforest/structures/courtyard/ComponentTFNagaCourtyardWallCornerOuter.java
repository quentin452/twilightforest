...
public class ComponentTFNagaCourtyardWallCornerOuter extends ComponentTFNagaCourtyardRotatedAbstract  {
	...
	public boolean addComponentParts(World world, Random rand, StructureBoundingBox sbb) {
    	...
    	//Horizontal rows
	    	//Outer
		    	this.placeBlockWithTileEntityAtCurrentPosition(world, TFBlocks.nagastoneEtched, 0, new TileEntityTFNagastoneEtched(EtchedNagastoneWest), 0, 5, 1, sbb);
		    	this.placeBlockWithTileEntityAtCurrentPosition(world, TFBlocks.nagastoneEtched, 0, new TileEntityTFNagastoneEtched(EtchedNagastoneWest), 0, 5, 2, sbb);
		    	this.placeBlockWithTileEntityAtCurrentPosition(world, TFBlocks.nagastoneEtched, 0, new TileEntityTFNagastoneEtched(EtchedNagastoneWest), 0, 5, 3, sbb);
		    	this.placeBlockWithTileEntityAtCurrentPosition(world, TFBlocks.nagastoneEtched, 0, new TileEntityTFNagastoneEtched(EtchedNagastoneWest), 0, 5, 4, sbb);
		    	
		    	this.placeBlockWithTileEntityAtCurrentPosition(world, TFBlocks.nagastoneEtched, 0, new TileEntityTFNagastoneEtched(EtchedNagastoneNorth), 1, 5, 0, sbb);
		    	this.placeBlockWithTileEntityAtCurrentPosition(world, TFBlocks.nagastoneEtched, 0, new TileEntityTFNagastoneEtched(EtchedNagastoneNorth), 2, 5, 0, sbb);
		    	this.placeBlockWithTileEntityAtCurrentPosition(world, TFBlocks.nagastoneEtched, 0, new TileEntityTFNagastoneEtched(EtchedNagastoneNorth), 3, 5, 0, sbb);
		    	this.placeBlockWithTileEntityAtCurrentPosition(world, TFBlocks.nagastoneEtched, 0, new TileEntityTFNagastoneEtched(EtchedNagastoneNorth), 4, 5, 0, sbb);
	    	//Inner
		    	this.fillWithMetadataBlocks(world, sbb, 3, 5, 2, 4, 5, 2, TFBlocks.nagastonePillar, horizontalColumnsOrient8, Blocks.air, 0, false);
		    	this.fillWithMetadataBlocks(world, sbb, 2, 5, 3, 2, 5, 4, TFBlocks.nagastonePillar, horizontalColumnsOrient4, Blocks.air, 0, false);

    	//Stone brick stairs
	    	//Upper ornament
		    	this.fillWithMetadataBlocks(world, sbb, 1, 6, 0, 4, 7, 0, Blocks.stone_brick_stairs, rotatedStairs5, Blocks.air, 0, false);
		    	this.fillWithMetadataBlocks(world, sbb, 0, 6, 1, 0, 7, 4, Blocks.stone_brick_stairs, rotatedStairs6, Blocks.air, 0, false);
	    	//Middle ornament
		    	//Outer
			    	this.fillWithMetadataBlocks(world, sbb, 1, 4, 0, 4, 4, 0, Blocks.stone_brick_stairs, rotatedStairs5, Blocks.air, 0, false);
			    	...
			    	this.fillWithMetadataBlocks(world, sbb, 0, 4, 1, 0, 4, 4, Blocks.stone_brick_stairs, rotatedStairs6, Blocks.air, 0, false);
    	...
    	//Snake ornament
	    	this.placeBlockWithTileEntityAtCurrentPosition(world, TFBlocks.nagastone, 1, new TileEntityTFNagastone(TileEntityTFNagastone.Direction.SIDE, NagastoneSouth), 1, 2, 1, sbb);
	    	this.placeBlockWithTileEntityAtCurrentPosition(world, TFBlocks.nagastone, 1, new TileEntityTFNagastone(TileEntityTFNagastone.Direction.SIDE, NagastoneSouth), 2, 2, 1, sbb);
	    	this.placeBlockWithTileEntityAtCurrentPosition(world, TFBlocks.nagastone, 1, new TileEntityTFNagastone(TileEntityTFNagastone.Direction.SIDE, NagastoneSouth), 3, 2, 1, sbb);
	    	this.placeBlockWithTileEntityAtCurrentPosition(world, TFBlocks.nagastone, 1, new TileEntityTFNagastone(TileEntityTFNagastone.Direction.SIDE, NagastoneSouth), 4, 2, 1, sbb);
	    	this.placeBlockWithTileEntityAtCurrentPosition(world, TFBlocks.nagastone, 1, new TileEntityTFNagastone(TileEntityTFNagastone.Direction.UP,   NagastoneNorth), 4, 3, 1, sbb);
	    	this.placeBlockWithTileEntityAtCurrentPosition(world, TFBlocks.nagastone, 0, new TileEntityTFNagastone(TileEntityTFNagastone.Direction.SIDE, NagastoneNorth), 3, 3, 1, sbb);
	    	this.placeBlockWithTileEntityAtCurrentPosition(world, TFBlocks.nagastoneEtched, 0, new TileEntityTFNagastoneEtched(EtchedNagastoneNorth), 					 2, 3, 1, sbb);

	    	this.placeBlockWithTileEntityAtCurrentPosition(world, TFBlocks.nagastone, 1, new TileEntityTFNagastone(TileEntityTFNagastone.Direction.SIDE, NagastoneWest), 1, 2, 1, sbb);
	    	this.placeBlockWithTileEntityAtCurrentPosition(world, TFBlocks.nagastone, 1, new TileEntityTFNagastone(TileEntityTFNagastone.Direction.SIDE, NagastoneWest), 1, 2, 2, sbb);
	    	this.placeBlockWithTileEntityAtCurrentPosition(world, TFBlocks.nagastone, 1, new TileEntityTFNagastone(TileEntityTFNagastone.Direction.SIDE, NagastoneWest), 1, 2, 3, sbb);
	    	this.placeBlockWithTileEntityAtCurrentPosition(world, TFBlocks.nagastone, 1, new TileEntityTFNagastone(TileEntityTFNagastone.Direction.SIDE, NagastoneWest), 1, 2, 4, sbb);
	    	this.placeBlockWithTileEntityAtCurrentPosition(world, TFBlocks.nagastone, 1, new TileEntityTFNagastone(TileEntityTFNagastone.Direction.UP,   NagastoneEast), 1, 3, 4, sbb);
	    	this.placeBlockWithTileEntityAtCurrentPosition(world, TFBlocks.nagastone, 0, new TileEntityTFNagastone(TileEntityTFNagastone.Direction.SIDE, NagastoneEast), 1, 3, 3, sbb);
	    	this.placeBlockWithTileEntityAtCurrentPosition(world, TFBlocks.nagastoneEtched, 0, new TileEntityTFNagastoneEtched(EtchedNagastoneWest), 					  1, 3, 2, sbb);
